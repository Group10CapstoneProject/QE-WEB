...
WebUI.click(findTestObject('Object Repository/2trainer/Page_AltaGym/span_Trainer'))
...
WebUI.click(findTestObject('Object Repository/2trainer/Page_AltaGym/i_testttt_bx bx-trash-alt'))

WebUI.click(findTestObject('Object Repository/2trainer/Page_AltaGym/button_Ya'))

WebUI.verifyElementVisible(findTestObject('Object Repository/2trainer/Page_AltaGym/div_success delete trainer skill'))
