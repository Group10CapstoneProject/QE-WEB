...
WebUI.click(findTestObject('Object Repository/2trainer/Page_AltaGym/i_Tidur Melek_bx bxs-edit-alt'))

WebUI.setText(findTestObject('Object Repository/2trainer/Page_AltaGym/textarea_Lorem ipsum dolor sit amet consect_7e45ec'), 
    'Lorem ipsum dolor sit amet consectetur               adipisicing elit. okeey deserunt ipsum velit quod impedit?')

WebUI.click(findTestObject('Object Repository/2trainer/Page_AltaGym/button_simpan'))

WebUI.verifyElementVisible(findTestObject('Object Repository/2trainer/Page_AltaGym/div_success update skill'))
