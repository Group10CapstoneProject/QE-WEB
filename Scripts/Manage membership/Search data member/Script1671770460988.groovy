...
WebUI.setText(findTestObject('Object Repository/1member/Page_React App/input_Kelola Member_input input-bordered in_614357'), 
    'Annida')

WebUI.verifyElementText(findTestObject('Object Repository/1member/Page_React App/td_Annida'), 'Annida')
