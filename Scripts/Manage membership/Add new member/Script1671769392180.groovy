...
WebUI.setText(findTestObject('Object Repository/1member/Page_React App/input_total_email'), 'rannida@gmail.com')
...
WebUI.setText(findTestObject('Object Repository/1member/Page_React App/input_total_duration'), '5')

WebUI.setText(findTestObject('Object Repository/1member/Page_React App/input_total_total'), '200000')

WebUI.click(findTestObject('Object Repository/1member/Page_React App/button_Tambah'))

WebUI.verifyElementVisible(findTestObject('Object Repository/1member/Page_React App/div_new member success created'))
